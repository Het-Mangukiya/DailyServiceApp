...
public class PreferenceManager {
    ...
    public void setLoggedIn(boolean isLoggedIn) {
        sharedPreferences.edit().putBoolean(Constants.KEY_IS_LOGGED_IN, isLoggedIn).commit();
    }
    ...
    /**
     * Saves all user data at once. Uses commit() for immediate persistence 
     * to avoid race conditions during activity transitions.
     */
    public void saveUserData(String userId, String email, String name, String role) {
        ...
        editor.commit(); // Synchronous write for critical session data
    }
