...
public class TestDataGenerator {
    ...
    /** Callback for {@link #generateDataForCustomer}. */
    public interface OnDataGeneratedListener {
        void onSuccess(int entriesCount);
        void onError(String error);
    }

    /**
     * No-op in release builds. Only functional in the debug source set.
     */
    public void generateDataForCustomer(
            String customerId,
            double quantity,
            double rate,
            int startYear,
            int startMonth,
            int monthsCount,
            OnDataGeneratedListener listener) {
        // Release stub — implementation lives in debug/
    }
}
